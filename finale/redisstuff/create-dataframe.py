...
experiment_name = 'productcatalog/'
...
Xtr_r = scaler.fit_transform(df_full[['name','rating_count','rating_value','has_image','identifier_count','list_length',
...
print (df_full.head())
print (df_full.shape)
df_full.to_csv('dataframes/' + experiment_name + domain + '.csv')
